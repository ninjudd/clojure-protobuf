...
;; In lein 1 there was a :target-dir key that defaulted to "." and wasn't really
;; used much. In lein 2, things that are generated by plugins and such are
;; supposed to go in :target-path. This will default to 'target'. We don't want
;; to wait for this, so we'll simulate it here.
(defn target [project]
  (doto (io/file (or (:target-path project) "target"))
    .mkdirs))
